...
int main() try
{
    ...
    while (true) {
        ...
        std::cout << "Press enter to capture or q then enter to exit..." << std::endl;
        ...
        cloud_fn << "../data/" << capture_count << "_cloud.pcd";
        ...
        colour_fn << "../data/" << capture_count << "_colour.png";
        ...
        ir_fn << "../data/" << capture_count << "_ir.png";
        ...
        depth_fn << "../data/" << capture_count << "_depth.png";
