...
bool save_image_service(std_srvs::Trigger::Request &req,
...
{
    ros::init(argc, argv, "capture_checkerboard_images");
    ros::NodeHandle nh("capture_checkerboard_images");

    ros::ServiceServer service = nh.advertiseService("trigger_save_checkerboard_images", save_image_service);
