...
items = seen[:16] + unseen[:16]
random.shuffle(items)
print(json.dumps(items, indent=4, separators=(',', ': ')))

random.shuffle(items)
print(json.dumps(items[:5], indent=4, separators=(',', ': ')))
print(json.dumps(items[5:8], indent=4, separators=(',', ': ')))
print(json.dumps(items[8:10], indent=4, separators=(',', ': ')))
